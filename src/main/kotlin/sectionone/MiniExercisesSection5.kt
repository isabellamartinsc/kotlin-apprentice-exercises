...
/*2. Write a for loop to iterate over the same range as in the exercise above and print the square root of each number.
...
/*4. Change this to use a step clause on the first for loop to skip even rows instead of using continue.
